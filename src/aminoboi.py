# coding = utf-8
# Library rewrited and made by - github.com/deluvsushi
# Original - зак тебя не укажу сасни
import json
import hmac
import time
import string
...
class Client:
    def __init__(
            self,
            device_Id: str = "221EAE9F9C08B08EA4F632F4C397847FC606A4BCD2E449B175997630041414E121C54063A5EC0E02C8",
            proxy: dict = None):
    ...
    def generate_signature(self, data):
        signature = base64.b64encode(
            bytes.fromhex("22") +
            hmac.new(
                bytes.fromhex("307c3c8cd389e69dc298d951341f88419a8377f4"),
                data.encode("utf-8"),
    ...
    def send_active_object(
        ...
        ndc_msg_sig = self.generate_signature(data=data)
        request = requests.post(
            f"{self.api}/x{ndc_Id}/s/community/stats/user-active-time?sid={self.sid}",
            data=data,
            headers=self.headers,
            proxies=self.proxy)
        return request.json()
    ...
    def accept_host(self, ndc_Id, thread_Id: str):
        ...
        ndc_msg_sig = self.generate_signature(data=data)
        request = requests.post(
            f"{self.api}/x{ndc_Id}/s/chat/thread/{thread_Id}/accept-organizer?sid={self.sid}",
            data=data,
            headers=self.headers,
            proxies=self.proxy)
        return request.json()
    ...
    def get_notifications(self, ndc_Id, start: int = 0, size: int = 10):
        request = requests.get(
            f"{self.api}/x{ndc_Id}/s/notification?start={start}&size={size}&sid={self.sid}",
            headers=self.headers,
            proxies=self.proxy)
        return request.json()
    ...
    def get_wallet_info(self):
        request = requests.get(
            f"{self.api}/g/s/wallet?sid={self.sid}",
            headers=self.headers,
            proxies=self.proxy)
        return request.json()
    ...
    def get_wallet_history(self, start: int = 0, size: int = 25):
        request = requests.get(
            f"{self.api}/g/s/wallet/coin/history?start={start}&size={size}&sid={self.sid}",
            headers=self.headers,
            proxies=self.proxy)
        return request.json()
    ...
    def my_communities(self, start: int = 0, size: int = 25):
        request = requests.get(
            f"{self.api}/g/s/community/joined?start={start}&size={size}&sid={self.sid}",
            headers=self.headers,
            proxies=self.proxy)
        return request.json()
    ...
    def watch_ad(self):
        request = requests.post(
            f"{self.api}/g/s/wallet/ads/video/start?sid={self.sid}",
            headers=self.headers,
            proxies=self.proxy)
        return request.json()
    ...
    def transfer_host(self, ndc_Id, thread_Id: str, user_Ids: list):
        ...
        ndc_msg_sig = self.generate_signature(data=data)
        request = requests.post(
            f"{self.api}/x{ndc_Id}/s/chat/thread/{thread_Id}/transfer-organizer?sid={self.sid}",
            data=data,
            headers=self.headers,
            proxies=self.proxy)
        return request.json()
    ...
    def join_thread(self, ndc_Id, thread_Id: str):
        request = requests.post(
            f"{self.api}/x{ndc_Id}/s/chat/thread/{thread_Id}/member/{self.auid}?sid={self.sid}",
            headers=self.headers,
            proxies=self.proxy)
        return request.json()
    ...
    def get_thread_messages(self, ndc_Id, thread_Id: str, size: int = 10):
        request = requests.get(
            f"{self.api}/x{ndc_Id}/s/chat/thread/{thread_Id}/message?v=2&pagingType=t&size={size}&sid={self.sid}",
            headers=self.headers,
            proxies=self.proxy)
        return request.json()
    ...
    def get_thread(self, ndc_Id, thread_Id: str):
        request = requests.get(
            f"{self.api}/x{ndc_Id}/s/chat/thread/{thread_Id}?sid={self.sid}",
            headers=self.headers,
            proxies=self.proxy)
        return request.json()
    ...
    def send_audio(self, path, ndc_Id, thread_Id: str):
        ...
        ndc_msg_sig = self.generate_signature(data=data)
        request = requests.post(
            f"{self.api}/x{ndc_Id}/s/chat/thread/{thread_Id}/message?sid={self.sid}",
            data=data,
            headers=self.headers,
            proxies=self.proxy)
        return request.json()
    ...
    def ban(self, ndc_Id, user_Id: str, reason: str, ban_type: int = None):
        ...
        ndc_msg_sig = self.generate_signature(data=data)
        request = requests.post(
            f"{self.api}/x{ndc_Id}/s/user-profile/{user_Id}/ban?sid={self.sid}",
            data=data,
            headers=self.headers,
            proxies=self.proxy)
        return request.json()
    ...
    def get_banned_users(self, ndc_Id, start: int = 0, size: int = 25):
        request = requests.get(
            f"{self.api}/x{ndc_Id}/s/user-profile?type=banned&start={start}&size={size}&sid={self.sid}",
            headers=self.headers,
            proxies=self.proxy)
        return request.json()
    ...
    def unban(self, ndc_Id, user_Id: str, reason: str):
        ...
        ndc_msg_sig = self.generate_signature(data=data)
        request = requests.post(
            f"{self.api}/x{ndc_Id}/s/user-profile/{user_Id}/unban?sid={self.sid}",
            data=data,
            headers=self.headers,
            proxies=self.proxy)
        return request.json()
    ...
    def create_chat_thread(self, ndc_Id, message: str, user_Id: str):
        ...
        ndc_msg_sig = self.generate_signature(data=data)
        request = requests.post(
            f"{self.api}/x{ndc_Id}/s/chat/thread?sid={self.sid}",
            data=data,
            headers=self.headers,
            proxies=self.proxy)
        return request.json()
    ...
    def delete_message(
        ...
        if not asStaff:
            request = requests.delete(
                f"{self.api}/x{ndc_Id}/s/chat/thread/{thread_Id}/message/{message_Id}?sid={self.sid}",
                headers=self.headers,
                proxies=self.proxy)
        else:
            request = requests.post(
                f"{self.api}/x{ndc_Id}/s/chat/thread/{thread_Id}/message/{message_Id}/admin?sid={self.sid}",
                data=data,
                headers=self.headers,
                proxies=self.proxy)
        return request.json()
    ...
    def kick(self, ndc_Id, thread_Id: str, user_Id: str, allowRejoin: int = 0):
        request = requests.delete(
            f"{self.api}/x{ndc_Id}/s/chat/thread/{thread_Id}/member/{user_Id}?allowRejoin={allowRejoin}&sid={self.sid}",
            headers=self.headers,
            proxies=self.proxy)
        return request.json()
    ...
    def load_sticker_Image(self, link: str):
        ...
        request = requests.post(
            f"{self.api}/g/s/media/upload/target/sticker?sid={self.sid}",
            data=data,
            headers=self.headers,
            proxies=self.proxy)
        return request.json()
    ...
    def create_sticker_pack(self, ndc_Id, name, stickers):
        ...
        ndc_msg_sig = self.generate_signature(data=data)
        request = requests.post(
            f"{self.api}/x{ndc_Id}/s/sticker-collection?sid={self.sid}",
            data=data,
            headers=self.headers,
            proxies=self.proxy)
        return request.json()
    ...
    def search_user_thread(self, ndc_Id, user_Id: str):
        request = requests.get(
            f"{self.api}/x{ndc_Id}/s/chat/thread?type=exist-single&cv=1.2&q={user_Id}&sid={self.sid}",
            headers=self.headers,
            proxies=self.proxy)
        return request.json()
    ...
    def change_vc_permission(self, ndc_Id, thread_Id: str, permission: int):
        ...
        ndc_msg_sig = self.generate_signature(data=data)
        request = requests.post(
            f"{self.api}/x{ndc_Id}/s/chat/thread/{thread_Id}/vvchat-permission?sid={self.sid}",
            headers=self.headers,
            data=data,
            proxies=self.proxy)
        return request.json()
    ...
    def get_thread_users(
            ...
            size: int = 25):
        request = requests.get(
            f"{self.api}/x{ndc_Id}/s/chat/thread/{thread_Id}/member?sid={self.sid}&type=default&start={start}&size={size}",
            headers=self.headers,
            proxies=self.proxy)
        return request.json()
    ...
    def my_chat_threads(self, ndc_Id, start: int = 0, size: int = 25):
        request = requests.get(
            f"{self.api}/x{ndc_Id}/s/chat/thread?type=joined-me&start={start}&size={size}&sid={self.sid}",
            headers=self.headers,
            proxies=self.proxy)
        return request.json()
    ...
    def thank_tip(self, ndc_Id, thread_Id: str, user_Id: str):
        request = requests.post(
            f"{self.api}/x{ndc_Id}/s/chat/thread/{thread_Id}/tipping/tipped-users/{user_Id}/thank?sid={self.sid}",
            headers=self.headers,
            proxies=self.proxy)
        return request.json()
    ...
    def get_user(self, ndc_Id, user_Id: str):
        request = requests.get(
            f"{self.api}/x{ndc_Id}/s/user-profile/{user_Id}?action=visit&sid={self.sid}",
            headers=self.headers,
            proxies=self.proxy)
        return request.json()
    ...
    def get_tipped_users_wall(
            ...
            size: int = 25):
        request = requests.get(
            f"{self.api}/x{ndc_Id}/s/blog/{blog_Id}/tipping/tipped-users-summary?start={start}&size={size}&sid={self.sid}",
            headers=self.headers,
            proxies=self.proxy)
        return request.json()
    ...
    def join_community(self, ndc_Id: int, invitation_Id: str = None):
        ...
        ndc_msg_sig = self.generate_signature(data=data)
        request = requests.post(
            f"{self.api}/x{ndc_Id}/s/community/join?sid={self.sid}",
            data=data,
            headers=self.headers,
            proxies=self.proxy)
        return request.json()
    ...
    def invite_to_chat(self, ndc_Id, thread_Id: str, user_Id: [str, list]):
        ...
        ndc_msg_sig = self.generate_signature(data=data)
        request = requests.post(
            f"{self.api}/x{ndc_Id}/s/chat/thread/{thread_Id}/member/invite?sid={self.sid}",
            data=data,
            headers=self.headers,
            proxies=self.proxy)
        return request.json()
    ...
    def get_online_members(self, ndc_Id, start: int = 0, size: int = 25):
        request = requests.get(
            f"{self.api}/x{ndc_Id}/s/live-layer?topic=ndtopic:x{ndc_Id}:online-members&start={start}&size={size}&sid={self.sid}",
            headers=self.headers,
            proxies=self.proxy)
        return request.json()
    ...
    def comment_profile(self, ndc_Id, content: str, user_Id: str):
        ...
        ndc_msg_sig = self.generate_signature(data=data)
        request = requests.post(
            f"{self.api}/x{ndc_Id}/s/user-profile/{user_Id}/comment?sid={self.sid}",
            data=data,
            headers=self.headers,
            proxies=self.proxy)
        return request.json()
    ...
    def get_user_blogs(
            ...
            size: int = 25):
        request = requests.get(
            f"{self.api}/x{ndc_Id}/s/blog?type=user&q={user_Id}&start={start}&size={size}&sid={self.sid}",
            headers=self.headers,
            proxies=self.proxy)
        return request.json()
    ...
    def check_In(self, ndc_Id: int = 0, tz: int = -int(time.timezone) // 1000):
        ...
        ndc_msg_sig = self.generate_signature(data=data)
        request = requests.post(
            f"{self.api}/x{ndc_Id}/s/check-in?sid={self.sid}",
            data=data,
            headers=self.headers,
            proxies=self.proxy)
        return request.json()
    ...
    def send_coins_blog(
        ...
        ndc_msg_sig = self.generate_signature(data=data)
        request = requests.post(
            f"{self.api}/x{ndc_Id}/s/blog/{blog_Id}/tipping?sid={self.sid}",
            data=data,
            headers=self.headers,
            proxies=self.proxy)
        return request.json()
    ...
    def send_coins_thread(
        ...
        ndc_msg_sig = self.generate_signature(data=data)
        request = requests.post(
            f"{self.api}/x{ndc_Id}/s/chat/thread/{thread_Id}/tipping?sid={self.sid}",
            data=data,
            headers=self.headers,
            proxies=self.proxy)
        return request.json()
    ...
    def lottery(self, ndc_Id, time_zone: str = -int(time.timezone) // 1000):
        ...
        ndc_msg_sig = self.generate_signature(data=data)
        request = requests.post(
            f"{self.api}/x{ndc_Id}/s/check-in/lottery?sid={self.sid}",
            data=data,
            headers=self.headers,
            proxies=self.proxy)
        return request.json()
    ...
    def edit_thread(
        ...
        if backgroundImage is not None:
            ...
            request = requests.post(
                f"{self.api}/x{ndc_Id}/s/chat/thread/{thread_Id}/member/{self.auid}/background?sid={self.sid}",
                data=data,
                headers=self.headers,
                proxies=self.proxy)
    ...
    def moderation_history_community(self, ndc_Id, size: int = 25):
        request = requests.get(
            f"{self.api}/x{ndc_Id}/s/admin/operation?pagingType=t&size={size}&sid={self.sid}",
            headers=self.headers,
            proxies=self.proxy)
        return request.json()
    ...
    def moderation_history_user(
            ...
            size: int = 25):
        request = requests.get(
            f"{self.api}/x{ndc_Id}/s/admin/operation?objectId={user_Id}&objectType=0&pagingType=t&size={size}&sid={self.sid}",
            headers=self.headers,
            proxies=self.proxy)
        return request.json()
    ...
    def moderation_history_blog(
            ...
            size: int = 25):
        request = requests.get(
            f"{self.api}/x{ndc_Id}/s/admin/operation?objectId={blog_Id}&objectType=1&pagingType=t&size={size}&sid={self.sid}",
            headers=self.headers,
            proxies=self.proxy)
        return request.json()
    ...
    def moderation_history_quiz(
            ...
            size: int = 25):
        request = requests.get(
            f"{self.api}/x{ndc_Id}/s/admin/operation?objectId={quiz_Id}&objectType=1&pagingType=t&size={size}&sid={self.sid}",
            headers=self.headers,
            proxies=self.proxy)
        return request.json()
    ...
    def moderation_history_wiki(
            ...
            size: int = 25):
        request = requests.get(
            f"{self.api}/x{ndc_Id}/s/admin/operation?objectId={wiki_Id}&objectType=2&pagingType=t&size={size}&sid={self.sid}",
            headers=self.headers,
            proxies=self.proxy)
        return request.json()
    ...
    def give_curator(self, ndc_Id, user_Id: str):
        request = requests.post(
            f"{self.api}/x{ndc_Id}/s/user-profile/{uid}/curator?sid={self.sid}",
            headers=self.headers,
            proxies=self.proxy)
        return request.json()
    ...
    def give_leader(self, ndc_Id, user_Id: str):
        request = requests.post(
            f"{self.api}/x{ndc_Id}/s/user-profile/{uid}/leader?sid={self.sid}",
            headers=self.headers,
            proxies=self.proxy)
        return request.json()
    ...
    def upload_bubble_1(self, file: str):
        ...
        request = requests.post(
            f"{self.api}/g/s/media/upload/target/chat-bubble-thumbnail?sid={self.sid}",
            data=data,
            headers=self.headers,
            proxies=self.proxy)
        return request.json()
    ...
    def upload_bubble_2(self, ndc_Id, template_Id, file: str):
        data = open(file, "rb").read()
        request = requests.post(
            f"{self.api}/x{ndc_Id}/s/chat/chat-bubble/{template_Id}?sid={self.sid}",
            data=data,
            headers=self.headers,
            proxies=self.proxy)
        return request.json()
    ...
    def generate_bubble(
        ...
        data = open(file, "rb").read()
        request = requests.post(
            f"{self.api}/x{ndc_Id}/s/chat/chat-bubble/templates/{template_Id}/generate?sid={self.sid}",
            data=data,
            headers=self.headers,
            proxies=self.proxy)
        return request.json()
    ...
    def get_bubble_info(self, ndc_Id, bubble_Id):
        request = requests.get(
            f"{self.api}/x{ndc_Id}/s/chat/chat-bubble/{bubble_Id}?sid={self.sid}",
            headers=self.headers,
            proxies=self.proxy)
        return request.json()
    ...
    def buy_bubble(self, ndc_Id, bubble_Id):
        ...
        ndc_msg_sig = self.generate_signature(data=data)
        request = requests.post(
            f"{self.api}/x{ndc_Id}/s/store/purchase?sid={self.sid}",
            data=data,
            headers=self.headers,
            proxies=self.proxy)
        return request.json()
    ...
    def invite_to_vc(self, ndc_Id, thread_Id: str, user_Id: str):
        ...
        ndc_msg_sig = self.generate_signature(data=data)
        request = requests.post(
            f"{self.api}/x{ndc_Id}/s/chat/thread/{thread_Id}/vvchat-presenter/invite?sid={self.sid}",
            data=data,
            headers=self.headers,
            proxies=self.proxy)
        return request.json()
    ...
    def delete_notification(self, ndc_Id, notification_Id: str):
        request = requests.delete(
            f"{self.api}/x{ndc_Id}/s/notification/{notificationId}?sid={self.sid}",
            headers=self.headers,
            proxies=self.proxy)
        return request.json()
    ...
    def edit_profile(
        ...
        if titles or colors:
            ...
            for titles, colors in zip(titles, colors):
                title_colors.append({"title": titles, "color": colors})
